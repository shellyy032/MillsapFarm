...
<body class="bg-teal-900 text-[#DAD7CD] font-sans">
  <div class="bg-teal-900 px-8 py-4 flex items-center justify-between shadow-lg">
    ...
    <div class="flex items-center space-x-8">
      <nav class="flex space-x-8 text-[#DAD7CD]">
        ...
        <a href="/production" class="hover:text-[#D4A373]">Production</a>
        <a href="/order" class="hover:text-[#D4A373]">Order</a>
        <a href="/manage" class="hover:text-[#D4A373]">Manage</a>
      </nav>
      <div class="relative">
  ...
  <script>
    ...
    <div class="mt-0 space-y-3 w-full">
    <details class="w-full bg-[#D9651A] cursor-pointer group overflow-hidden rounded-lg">
    <summary class="block w-full list-none flex justify-between items-center font-semibold text-gray-800 p-4">
      <span class="translate-x-2 block font-bold">SHORT OF STOCK!</span>
      <svg class="w-5 h-5 text-gray-600 transition-transform duration-200 group-open:rotate-180" 
           xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
      </svg>
    </summary>
      <div class="w-full bg-teal-900 py-8 flex flex-col items-center">
        <div class="flex items-center gap-4 w-full justify-center">
            <button class="text-white text-3xl cursor-pointer select-none">&lt;</button>
              <div class="bg-white w-[80%] max-w-[600px] p-6 rounded-lg shadow-lg">z
            ...
            <span class="text-white text-3xl cursor-pointer select-none">&gt;</span>
        </div>
      </div>
      <div class="w-full max-screen bg-teal-900 py-3 flex justify-center">
    ...
    <div class="mt-1 space-y-3 w-full">
      <details class="w-full bg-[#E9C46A] cursor-pointer group overflow-hidden rounded-lg">
        <summary class="block w-full list-none flex justify-between items-center font-semibold text-gray-800 p-4">
          <span class="translate-x-2 block font-bold">DAILY PRODUCTION</span>
          <svg class="w-5 h-5 text-gray-600 transition-transform duration-200 group-open:rotate-180" 
              xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </summary>
          <div class="w-full max-w-screen bg-teal-900 py-8 flex flex-col items-center">
    ...
    <div class="mt-1 space-y-3 w-full">
      <details class="w-full bg-[#A3B18A] cursor-pointer group overflow-hidden rounded-lg">
        <summary class="block w-full list-none flex justify-between items-center font-semibold text-gray-800 p-4">
          <span class="translate-x-2 block font-bold">BEST SELLER</span>
          <svg class="w-5 h-5 text-gray-600 transition-transform duration-200 group-open:rotate-180" 
              xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        ...
        <div class="w-full max-w-screen bg-teal-900 py-8 flex flex-col items-center">
          <h2 class="text-lg font-bold tracking-widest mt-5 mb-4 text-[#432818] text-center">BEST SELLER</h2>
            <div class="flex items-center gap-4 mx-auto">
            <div class="space-y-3 w-4/5 mx-auto">
      ...
      <div class="mt-1 space-y-3 w-full">
        <details id="qualityDetails" class="w-full bg-[#8FB16E] cursor-pointer group overflow-hidden rounded-lg">
          
          <summary class="block w-full list-none flex justify-between items-center font-semibold text-gray-800 p-4">
            <span class="translate-x-2 block font-bold">QUALITY GRAPH</span>
            <svg class="w-5 h-5 text-gray-600 transition-transform duration-200 group-open:rotate-180" 
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
            </svg>
          ...
          <div class="w-full max-w-screen bg-teal-900 py-8 flex flex-col items-center">
            <div class="max-w-7xl mx-auto grid grid-cols-2 gap-8 items-center">
              <div class="space-y-10 pl-10">
                <div class="space-y-4 text-sm">
                  <div class="text-green-300">
                    <h3 class="font-bold text-2xl">TERJUAL</h3>
                    <p>Lorem ipsum dolor sit amet</p>
                    <p class="font-bold">74,9%</p>
                  </div>
                  <div class="text-yellow-200">
                    <h3 class="font-bold text-2xl">SISA</h3>
                    <p>Lorem ipsum dolor sit amet</p>
                    <p class="font-bold">22,1%</p>
                  </div>
                  <div class="text-red-300">
                    <h3 class="font-bold text-2xl">RUSAK</h3>
                    <p>Lorem ipsum dolor sit amet</p>
              ...
              <div class="flex justify-center">
                <canvas id="qualityPieChart" class="w-[350px] h-[350px]"></canvas>
              </div>
            </div>
          </div>
        </details>
      ...
      document.getElementById("qualityDetails").addEventListener("toggle", function () {
        if (this.open) {
          setTimeout(renderQualityChart, 150);
        }
      });
      </script>


    <div class="mt-1 w-full space-y-6">
      @foreach($reports as $r)
        <details class="w-full bg-[#D4A373] cursor-pointer group overflow-hidden rounded-lg">
            <summary class="flex justify-between items-center font-semibold text-gray-800 p-4 list-none">
                <span class="font-bold">PROBLEM REPORT</span>
                <svg class="w-5 h-5 text-gray-600 transition-transform duration-200 group-open:rotate-180" 
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </summary>
            <div class="w-full bg-white py-8 px-8 space-y-8">
                <div class="flex justify-between items-center">
                    <h2 class="font-bold text-gray-700">DateTime</h2>
                    <span class="text-gray-700 font-semibold">{{ $r['datetime'] }}</span>
                </div>
                <div>
                    <label class="font-semibold text-gray-700">Judul Masalah</label>
                    <input type="text" class="w-full bg-[#1E3932] text-white p-3 rounded-lg mt-2" value="{{ $r['judul'] }}">
                </div>
                <div>
                    <label class="font-semibold text-gray-700">Deskripsi</label>
                    <textarea class="w-full bg-[#1E3932] text-white p-3 rounded-lg mt-2 h-40">{{ $r['deskripsi'] }}</textarea>
                </div>
                <div class="flex gap-10">
                    <div class="w-1/2">
                        <label class="font-semibold text-gray-700">Divisi</label>
                        <input type="text" class="w-full bg-[#1E3932] text-white p-3 rounded-lg mt-2" value="{{ $r['divisi'] }}">
                    </div>
                    <div class="w-1/2">
                        <label class="font-semibold text-gray-700">Foto Bukti</label>
                        <div class="flex items-center gap-3 mt-2">
                            <span class="text-gray-700">Upload PNG/PDF/JPG</span>
                            <input type="file" class="border rounded px-2 py-1">
                        </div>
                    </div>
                </div>
                <div class="flex justify-end gap-4 pt-4">
                    <button class="bg-gray-300 text-gray-800 px-6 py-2 rounded-full">Cancel</button>
                    <button class="bg-[#D4A373] text-white px-6 py-2 rounded-full">Update</button>
                </div>
            </div>
        </details>
      @endforeach
